...
2.  Run through the [Getting Started](https://general.veevavault.dev/vault-sdk/getting-started/) guide to set up your deployment environment.
...
To see the project in action, configure the  [debugger](https://general.veevavault.dev/vault-sdk/sdk-debugger/) and set breakpoints or [deploy](https://general.veevavault.dev/vault-sdk/deploying-code/) the code to your Vault.
